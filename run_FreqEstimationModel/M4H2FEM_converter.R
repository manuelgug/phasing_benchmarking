...
file <- c("../inputs/CONTROLS_ALL.csv")
...
write.csv(formatted_table, file = paste0("FEMcoded_", basename(file)))
write.csv(mean_allele_freq, file = paste0("FEMcoded_CODE_", basename(file)), row.names = F)
